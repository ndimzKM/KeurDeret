        ...
        <ScrollView style={{ marginTop: 20, marginHorizontal: 10 }}>
          ...
          <TouchableOpacity style={styles.thetop}>
            ...
            <View style={styles.child}>
              ...
              <Text style={{ color: "#1e3864" }}>
                Manage your account's secuirity and keep track of your account's
          ...
          <TouchableOpacity style={styles.thetop}>
            ...
            <View style={styles.child}>
              ...
              <Text style={{ color: "#1e3864" }}>
                Manage what information you see and share on KeurDeret
              </Text>
            </View>
            <TouchableOpacity>
              <MaterialIcons
          ...
          <TouchableOpacity style={styles.thetop}>
            ...
            <View style={styles.child}>
              ...
              <Text style={{ color: "#1e3864" }}>
                Mangae how KeurDeret content is displayed to you.
              </Text>
            </View>
            <TouchableOpacity>
              <MaterialIcons
